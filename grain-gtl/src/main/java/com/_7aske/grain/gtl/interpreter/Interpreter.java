...
import com._7aske.grain.gtl.ast.AstFragmentNode;
import com._7aske.grain.gtl.ast.AstFunctionCallback;
import com._7aske.grain.gtl.ast.basic.AstNode;
import com._7aske.grain.gtl.interpreter.exception.InterpreterException;
import com._7aske.grain.gtl.lexer.Lexer;
import com._7aske.grain.gtl.lexer.LexerException;
import com._7aske.grain.gtl.parser.Parser;
import com._7aske.grain.gtl.util.AstUtil;
...
public class Interpreter {
	...
	public Optional<AstFragmentNode> tryIncludeFragment(String path) {
		...
		try (InputStream fileInputStream = Interpreter.class.getClassLoader().getResourceAsStream(path)) {
			if (fileInputStream == null) {
				return Optional.empty();
			}

			byte[] content = fileInputStream.readAllBytes();
			return Optional.of(new AstFragmentNode(new String(content)));
		} catch (Exception e) {
			return Optional.empty();
		}
	}
